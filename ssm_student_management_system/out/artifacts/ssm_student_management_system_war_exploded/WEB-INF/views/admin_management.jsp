...
<div class="container-fluid">
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable col-lg-4">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="model-form" action="${pageContext.request.contextPath}/admin/add">
    ...
    <div class="non-top-nav row">
        ...
        <div class="main col-lg-10 p-3 pt-4">
            <form action="${pageContext.request.contextPath}/admin/management_condition" class="row" method="get">
                <div class="row">
                    ...
                    <tr>
                        ...
                        <td class="operation-col">
                            <div class="p-2 pt-0 pb-0 d-flex justify-content-between">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/delete?id=${item.id}" class="d-block btn btn-danger btn-sm">删除</a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
...
<script>
    ...
    addBtn.addEventListener('click', function () {
        modelForm.action = '${pageContext.request.contextPath}/admin/add'
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function (event) {
            ...
            modelForm.action = '${pageContext.request.contextPath}/admin/update'
            submitBtn.textContent = '修改'
            modelTitle.textContent = '修改'

            fetch("${pageContext.request.contextPath}" + "/admin/getById?id=" + button.dataset.id, {
                method: 'GET',
                headers: {
