...
<%@ page import="com.demo.main.entity.Teacher" %>
...
<div class="container-fluid">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="model-form" action="${pageContext.request.contextPath}/teacher/add">
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-3 col-form-label">部门</label>
                            <div class="col-lg-9">
                                <input type="text" name="department" class="form-control" placeholder="部门" value="">
                            </div>
                        </div>
    ...
    <div class="non-top-nav row">
        ...
        <div class="main col-lg-10 p-3 pt-4">
            <form action="${pageContext.request.contextPath}/teacher/management_condition" class="row" method="get">
                <div class="row">
                    ...
                    <tr>
                        ...
                        <td class="operation-col">
                            <div class="p-2 pt-0 pb-0 d-flex justify-content-between">
                                ...
                                <a href="${pageContext.request.contextPath}/teacher/delete?id=${item.id}" class="d-block btn btn-danger btn-sm">删除</a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
...
<script>
    ...
    addBtn.addEventListener('click', function () {
        modelForm.action = '${pageContext.request.contextPath}/teacher/add'
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function (event) {
            ...
            modelForm.action = '${pageContext.request.contextPath}/teacher/update'
            submitBtn.textContent = '修改'
            modelTitle.textContent = '修改'

            fetch("${pageContext.request.contextPath}" + "/teacher/getById?id=" + button.dataset.id, {
                method: 'GET',
                headers: {
