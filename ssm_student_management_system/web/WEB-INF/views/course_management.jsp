...
<%@ page import="com.demo.main.entity.Course" %>
...
<div class="container-fluid">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="model-form" action="${pageContext.request.contextPath}/course/add">
                        ...
                        <div class="mb-3 row">
                            <label class="col-lg-3 col-form-label">教师ID</label>
                            <div class="col-lg-9">
                                <input type="text" name="teacherId" class="form-control" placeholder="教师ID" value="">
                            </div>
                        </div>
    ...
    <div class="non-top-nav row">
        ...
        <div class="main col-lg-10 p-3 pt-4">
            <form action="${pageContext.request.contextPath}/course/management_condition" class="row" method="get">
                <div class="row">
                    ...
                    <tr>
                        ...
                        <td class="operation-col">
                            <div class="p-2 pt-0 pb-0 d-flex justify-content-between">
                                ...
                                <a href="${pageContext.request.contextPath}/course/delete?id=${item.id}" class="d-block btn btn-danger btn-sm">删除</a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
...
<script>
    ...
    addBtn.addEventListener('click', function () {
        modelForm.action = '${pageContext.request.contextPath}/course/add'
    ...
    editButtons.forEach(function(button) {
        button.addEventListener('click', function (event) {
            ...
            modelForm.action = '${pageContext.request.contextPath}/course/update'
            submitBtn.textContent = '修改'
            modelTitle.textContent = '修改'

            fetch("${pageContext.request.contextPath}" + "/course/getById?id=" + button.dataset.id, {
                method: 'GET',
                headers: {
